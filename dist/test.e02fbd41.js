...
})({"ha2uW":[function(require,module,exports,__globalThis) {
...
function reducer(state = initialState, action) {
    switch(action.type){
        ...
        case WISHLIST_REMOVE_ITEM:
            return {
                ...state,
                wishList: state.wishList.filter((productId)=>productId !== action.payload.productId)
            };
        default:
            return state;
    }
...
},{"redux":"7RvxM","./productsList":"75H0b"}],"7RvxM":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gN1rx"}],"gN1rx":[function(require,module,exports,__globalThis) {
